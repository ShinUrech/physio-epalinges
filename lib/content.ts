...
export type Treatment = { id: string; title: string; desc: string; image?: string; imagePosition?: string; fit?: 'cover' | 'contain' };
...
export const treatments: Treatment[] = [
  ...
  { id: 'cervicalgie', image: '/gallery/photos/DSC03131.jpg', imagePosition: 'center 66%', title: "Traitement de Cervicalgie / Cervicobrachigie", desc: "Prise en charge complète des douleurs cervicales et des irradiations vers le bras (cervicobrachigie), causées par une atteinte discale, une compression nerveuse ou un déséquilibre musculaire. Le traitement combine thérapie manuelle ciblée, mobilisations neurales et techniques Mulligan pour éliminer la douleur à la source, associé à des exercices de stabilisation cervicale progressive pour prévenir les récidives." },
  { id: 'atm', image: '/gallery/photos/DSC03254.jpg', imagePosition: 'center 72%', title: "Traitement de l'ATM", desc: "L'ATM (articulation temporo-mandibulaire) peut souffrir d'un déséquilibre musculaire, provoquant des douleurs au niveau de la mâchoire, des tempes, des sinus ou de la nuque. Je prends en charge ces dysfonctions avec des techniques manuelles ciblées incluant la mobilisation articulaire, le relâchement des muscles masticateurs (ptérygoïdien, temporal, masséter) et la rééducation posturale cranio-cervicale." },
...
export const SITE_URL = 'https://giuseppecostaphysio.ch';
