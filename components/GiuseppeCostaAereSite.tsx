    ...
    <div className="min-h-screen bg-neutral-200 font-sans text-slate-800">
      ...
      <nav className="bg-neutral-950 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-10 text-sm font-medium text-neutral-300">
      ...
      <header className="relative bg-neutral-950 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 md:py-48 flex flex-col items-center text-center">
          ...
          <p className="text-2xl md:text-3xl text-neutral-300 mb-12 max-w-3xl font-semibold leading-snug">
            Physiothérapeute du sport et thérapie manuelle
          </p>
          <div className="flex flex-col sm:flex-row gap-6">
            <a href="https://www.onedoc.ch/en/physiotherapist/epalinges/pcyqz/giuseppe-costa" target="_blank" rel="noopener noreferrer" className="bg-neutral-200 text-neutral-950 px-10 py-4 rounded-full text-lg font-bold flex items-center justify-center hover:bg-neutral-300 transition-colors shadow-xl">
              Prendre rendez-vous <ArrowRight className="ml-2.5 w-5 h-5" />
            </a>
            <a href="tel:+41217842666" className="border-2 border-neutral-400 text-white px-10 py-4 rounded-full text-lg font-bold flex items-center justify-center hover:bg-neutral-800 transition-colors">
      ...
      <section id="cabinet" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-[1.5fr,1fr] gap-16 items-center">
          <div>
            ...
            <div className="w-24 h-2 bg-neutral-800 mb-10 rounded-full"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-5 text-slate-950 font-semibold text-lg">
              <p className="flex items-center"><ArrowRight className="w-5 h-5 mr-3.5 text-neutral-600" />Thérapie manuelle OMPT</p>
              <p className="flex items-center"><ArrowRight className="w-5 h-5 mr-3.5 text-neutral-600" />Rééducation sportive d&apos;élite</p>
              <p className="flex items-center"><ArrowRight className="w-5 h-5 mr-3.5 text-neutral-600" />Dry needling &amp; ondes de choc</p>
              <p className="flex items-center"><ArrowRight className="w-5 h-5 mr-3.5 text-neutral-600" />Reconnu Croix-Rouge &amp; NAREG</p>
            </div>
          </div>
          {/* Office carousel */}
          <div className="relative h-[450px]">
            <button
              ...
              className="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-neutral-200/80 shadow-md border border-neutral-300 rounded-full p-2 hover:bg-neutral-300 transition-colors"
            ...
            <button
              onClick={() => officeCarouselRef.current?.scrollBy({ left: 320, behavior: 'smooth' })}
              className="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-neutral-200/80 shadow-md border border-neutral-300 rounded-full p-2 hover:bg-neutral-300 transition-colors"
              aria-label="Suivant"
            >
      ...
      {/* TRAITEMENTS SECTION */}
      <section id="specialites" className="bg-neutral-50 py-24 px-6 border-y border-neutral-200">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <h2 className="text-4xl font-extrabold text-neutral-900 mb-5 tracking-tight">Services et Traitements Spécialisés</h2>
          <div className="w-20 h-1.5 bg-neutral-800 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          {[
            ...
            <div key={index} className="bg-neutral-100 rounded-3xl shadow-sm border border-neutral-200 hover:shadow-xl transition-shadow flex flex-col overflow-hidden">
              <div className="w-full h-48 bg-neutral-300 flex items-center justify-center text-neutral-500 text-sm">Photo</div>
              <div className="p-8 flex flex-col items-start">
                <h3 className="text-2xl font-bold mb-4 text-neutral-950 tracking-tight leading-tight">{item.title}</h3>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-4xl font-extrabold text-neutral-900 mb-5 tracking-tight">Spécialisations cliniques</h2>
          <p className="text-xl text-neutral-600 max-w-2xl mx-auto font-medium">Expert dans la prise en charge des pathologies orthopédiques et des traumatismes sportifs complexes</p>
          <div className="w-20 h-1.5 bg-neutral-800 mx-auto rounded-full mt-8"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          {[
            ...
            <div key={index} className="bg-neutral-100 pt-6 pb-10 px-6 rounded-2xl border border-neutral-200 hover:border-neutral-400 transition-colors flex flex-col items-center shadow-sm">
              <div style={{ width: 128, height: 128, borderRadius: '50%', overflow: 'hidden', flexShrink: 0, marginBottom: '1.5rem', background: '#e5e5e5' }}>
                <div style={{ marginTop: item.crop.marginTop }}>
                  <Model
                    data={[{ name: item.title, muscles: item.muscles } as IExerciseData]}
                    highlightedColors={['#404040']}
                    bodyColor="#d4d4d4"
      ...
      {/* GALLERY SECTION */}
      <section className="bg-neutral-50 py-24 px-6 border-y border-neutral-200">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-extrabold text-neutral-900 mb-5 tracking-tight">Galerie</h2>
          <div className="w-20 h-1.5 bg-neutral-800 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
          {([
            ...
            <div key={i} className="break-inside-avoid rounded-2xl overflow-hidden shadow-sm border border-neutral-200">
              {item.type === 'image' ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img
                  src={item.src}
      ...
      <section className="bg-neutral-100 py-20 px-6 border-y border-neutral-200">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-extrabold text-neutral-950 mb-8 tracking-tight">Excellence Académique et Professionnelle</h2>
          <div className="w-24 h-2 bg-neutral-800 mb-12 rounded-full"></div>
          <div className="grid md:grid-cols-2 gap-x-16 gap-y-6 font-semibold text-neutral-900 leading-relaxed text-xl">
            <p className="flex items-start"><ArrowRight className="w-6 h-6 mr-4 text-neutral-600 shrink-0 mt-1.5" />
      ...
      <footer id="contact" className="bg-neutral-950 text-neutral-400 py-24 px-6 border-t-4 border-neutral-600 mt-24">
            ...
            <div>
              ...
              <ul className="space-y-7 text-lg">
                <li className="flex items-start">
                  <MapPin className="w-7 h-7 mr-5 text-neutral-400 shrink-0 mt-1" />
                  <div>
                ...
                <li className="flex items-center">
                  <Phone className="w-7 h-7 mr-5 text-neutral-400 shrink-0" />
                  <span className="font-bold text-white text-xl">021 784 26 66</span>
                </li>
                <li className="flex items-center">
                  <Clock className="w-7 h-7 mr-5 text-neutral-400 shrink-0" />
                  <span className="text-xl">Horaires sur demande</span>
                </li>
              </ul>
            </div>
            <div className="mt-12 w-full sm:w-auto">
              <a href="https://www.onedoc.ch/en/physiotherapist/epalinges/pcyqz/giuseppe-costa" target="_blank" rel="noopener noreferrer" className="inline-block bg-neutral-200 text-neutral-950 px-10 py-4 rounded-full text-lg font-bold hover:bg-neutral-300 transition-colors shadow-lg w-full text-center">
                Prise de RDV en ligne
              </a>
            </div>
          </div>

          <div className="h-full border border-neutral-700 rounded-3xl overflow-hidden p-4 bg-neutral-100 shadow-xl">
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-neutral-800 text-base text-center text-neutral-500 font-medium">
